...
public class ComboSaveOnlyAndCredit extends Combos {
    ...
    public ComboSaveOnlyAndCredit() {
        GIFT_200DOLLARS = 200.0;
    }

    public ComboSaveOnlyAndCredit(BankAccount account_Colones, BankAccount account_Dollars, BankAccount account_Euros, BankAccount account_Credit) {
