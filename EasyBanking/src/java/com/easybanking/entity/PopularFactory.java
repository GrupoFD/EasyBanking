...
public class PopularFactory extends ComboFactory {
    ...
    public SuperCreditCombo createSuperCredit(Bank issuer, Person personOwner) {
        ...
        BankAccount dollarCredit = new Credit(D_MAXCREDIT_SPECIAL, D_CR_MIN_PAYMENT_REGULAR, LAST_BALANCE, ISGOOD_FORLOAN, accNumber01, issuer, D_MAXCREDIT_SPECIAL, CURRENCY_DOLLAR, personOwner, TODAY, FIVE_YEARS_FROM_TODAY, SPECIAL_GIFTPOINTS_100);
        // Combo
    ...
    public UseCreditAndSaveCombo createUseCreditAndSave(Bank issuer, Person personOwner, double openingAmount) {
        ...
        BankAccount dollarCredit = new Credit(D_MAXCREDIT_SPECIAL, D_CR_MIN_PAYMENT_COMPANY, LAST_BALANCE, ISGOOD_FORLOAN, accNumber02, issuer, D_MAXCREDIT_SPECIAL, CURRENCY_DOLLAR, personOwner, TODAY, FIVE_YEARS_FROM_TODAY, SPECIAL_GIFTPOINTS_100);
        // Combo
